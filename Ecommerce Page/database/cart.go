...
import (
	...
	"github.com/GrantCoding/ecommerce-page/models"
...
var (
	...
	ErrCantRemoteItemCart = errors.New("can't remove this item from the cart")
	ErrCantGetItem = errors.New("unable to retrieve item from the cart")
...
func BuyItemFromCart(ctx context.Context, userCollection *mongo.Collection, userID string) error {
	...
	//create item order
	//added user order to collection
	//added cart items to order list
	//empty cart
	...
	userCollection.UpdateOne(ctx, filter3, update3)
	if err != nil{
